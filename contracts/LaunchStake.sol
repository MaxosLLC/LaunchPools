...
contract LaunchStake is IStakingRewards, Stakeholder, ReentrancyGuard {
    ...
    function earned(address account) override public view returns (uint256) {
        return _balances[account].mul(rewardPerToken()
    ...
    external nonReentrant updateReward(msg.sender) {
        ...
        // permit
        ILaunchPoolsERC20(address(stakingToken))
    ...
    function notifyRewardAmount(uint256 reward) override external onlyStakeholder updateReward(address(0)) {
